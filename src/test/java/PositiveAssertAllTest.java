...
import static generator.Helper.createTwoDetectiveResponse;
...
public class PositiveAssertAllTest {
    ...
    public void testPositiveAssertAll(String name, boolean isSherlock) {
        DetectivesResponse detectivesResponse = createTwoDetectiveResponse(
            ...
            assertAll("Detectives",
                    () -> {
                        ...
                        if (hasSherlock) {assertEquals(hasSherlock, detectivesResponse.isSuccess(),
